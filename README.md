...
| Project                                        | Description                                                                      |
| ---------------------------------------------- | -------------------------------------------------------------------------------- |
| [**Seismic Gaming**](https://seismicgaming.eu) | Multi-gaming community (18+) — Laravel, Discord API, Livewire, Tailwind          |
| [**Clans.gg**](https://clans.gg)               | Central hub for gaming clans — roster, applications, events, Discord integration |
| [**NodeForge.gg**](https://nodeforge.gg)       | Dashboard for communities to run and manage game servers — Laravel, React, Go    |
